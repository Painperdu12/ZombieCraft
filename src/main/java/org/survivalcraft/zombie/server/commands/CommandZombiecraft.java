...
public class CommandZombiecraft extends CommandBase {
	...
	if(args.length <= 0) {
	    sender.addChatMessage(ChatHelper.getFormattedComponent("&cUse &4/zombiecraft help&c for more information."));
	    return;
	}
	...
	if(args[0].equalsIgnoreCase("help")) {
	    ...
	    sender.addChatMessage(ChatHelper.getFormattedComponent("&c/zombiecraft weather set <type> &8- &7Sets the weather."));
	...
	if(args[0].equalsIgnoreCase("weather")) {
		...
		if(args.length < 3) {
		    sender.addChatMessage(ChatHelper.getFormattedComponent("&cUse &4/zombiecraft help&c for more information."));
		    sender.addChatMessage(ChatHelper.getFormattedComponent("&7Possible values: Normal, Rain, Storm, Foggy"));
		    return;
		}
