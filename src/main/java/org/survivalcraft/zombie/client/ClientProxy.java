...
public class ClientProxy extends CommonProxy {
	...
	super.init(event);
	Logger.initInfo("Client-side Initializiation of ZombieCraft.");
	...
	Logger.initInfo("- Registering Entity Renderers...");

	RenderingRegistry.registerEntityRenderingHandler(EntityInfected.class,
		new RenderHumanoid(new ModelHumanoid(), RenderHumanoid.BIG_SCALE));
    }

    public void registerBlockRenderers() {
	Logger.initInfo("- Registering Blocks Renderers...");
	...
	Logger.initInfo("- Registering Items Renderers...");

	MinecraftForgeClient.registerItemRenderer(ModItems.fireAxe, new RenderItem(new ModelFireAxe(),
		new ResourceLocation(SharedConstants.MODID, "textures/items/models/fireAxe.png")));
    }

    public void registerKeyBindings() {
	Logger.initInfo("- Registering KeyBindings...");
