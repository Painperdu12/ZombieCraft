...
public class RenderHumanoid extends RenderBiped {
	...
	if(pass == 0) {
	    this.bindTexture(new ResourceLocation(SharedConstants.MODID,
		    "textures/entities/human/" + c.textureName + "/eyes_" + c.eyes + ".png"));
	    return 1;
	} else if(pass == 1) {
	    this.bindTexture(new ResourceLocation(SharedConstants.MODID,
		    "textures/entities/human/" + c.textureName + "/hair_" + c.hair + ".png"));
	    return 1;
	} else if(pass == 2) {
	    this.bindTexture(new ResourceLocation(SharedConstants.MODID,
		    "textures/entities/human/" + c.textureName + "/shirt_" + c.shirt + ".png"));
	    return 1;
	} else if(pass == 3) {
	    this.bindTexture(new ResourceLocation(SharedConstants.MODID,
		    "textures/entities/human/" + c.textureName + "/pants_" + c.pants + ".png"));
	    return 1;
	}
	...
	if(pose == EnumHumanoidPose.CROUNCH)
	    d3 -= 0.3d;
	if(pose == EnumHumanoidPose.SIT)
	    d3 -= 0.9d;
	...
	EntityHumanoid human = (EntityHumanoid) entity;
	return new ResourceLocation(SharedConstants.MODID, "textures/entities/human/"
		+ human.getCharateristics().textureName + "/body_" + human.getCharateristics().body + ".png");
    }
}