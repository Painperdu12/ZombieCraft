...
import org.survivalcraft.zombie.client.models.block.ModelTrashcan;
...
public class RenderTrashcan extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(SharedConstants.MODID, "textures/blocks/props/trashcan.png");
    private final ModelTrashcan modelTrashcan;

    public RenderTrashcan() {
	this.modelTrashcan = new ModelTrashcan();
    }
	...
	this.modelTrashcan.render(null, 0, 0, 0, 0, 0, 0.0625f);
