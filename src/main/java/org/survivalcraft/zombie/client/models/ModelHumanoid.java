package org.survivalcraft.zombie.client.models;
...
public class ModelHumanoid extends ModelBiped {
    ...
    @Override
    public void setRotationAngles(float limb, float limbAmount, float ageTicks, float headYaw, float headPitch,
	...
	if(pose == EnumHumanoidPose.HAPPY) {
	    ...
	    super.setRotationAngles(limb, limbAmount, ageTicks, headYaw, headPitch, scale, entity);
    }
}