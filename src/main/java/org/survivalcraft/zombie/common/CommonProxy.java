...
import org.survivalcraft.zombie.common.blocks.tiles.ModTiles;
...
public class CommonProxy {
	...
	Logger.initInfo("Pre-Initialization of ZombieCraft version " + SharedConstants.MOD_VERSION);
	Logger.initInfo("Registering all ZombieCraft game elements...");
	...
	Logger.initInfo("Initializing Messages Channel");
	NetworkHandler.init();
    }
