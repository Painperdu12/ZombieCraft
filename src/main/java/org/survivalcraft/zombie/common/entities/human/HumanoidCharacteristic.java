...
public class HumanoidCharacteristic {
	...
	public static HumanoidCharacteristic generateRandomCharacteristic(Random rand, String texture, int maxEyes, int maxBody, int maxShirt, int maxPants, int maxHair) {
