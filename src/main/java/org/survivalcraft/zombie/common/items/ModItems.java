...
public class ModItems {
    ...
    public static ItemIngredient wires;

    private static void init() {
	Logger.initInfo("- Registering Items");

	bandage = new ItemBandage();
	dirtyBandage = new ItemDirtyBandage();
	emptySyringe = new Item().setCreativeTab(TabsZombieCraft.ITEMS).setUnlocalizedName("emptySyringe")
		.setTextureName("zombiecraft:emptySyringe");
	infectedSyringe = new ItemInfectedSyringe();
	cureSyringe = new ItemCureSyringe();

	emptyBottle = new Item().setCreativeTab(TabsZombieCraft.ITEMS).setUnlocalizedName("emptyBottle")
		.setTextureName("zombiecraft:emptyBottle");
	...
	emptyCan = new Item().setCreativeTab(TabsZombieCraft.ITEMS).setUnlocalizedName("emptyCan")
		.setTextureName("zombiecraft:emptyCan");
	...
	wires = new ItemIngredient("wires", "Can be traded for caps");
    }
